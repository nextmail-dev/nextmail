...
NextMail 是基于 Tauri 2、React/TypeScript 和 Rust 的本地优先桌面邮件客户端，当前版本为 `0.6.6`。
...
- 客户端头为 `X-Mailer: NextMail/0.6.6`；该值由 Cargo package version 自动生成，版本变化时同步核对各 manifest。
