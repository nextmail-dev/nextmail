...
以上编号 iteration 作为历史保留。自 2026-08-09 起，每次新的开发计划使用 `YYYY-MM-DD-主题.md` 命名，不再分配阶段编号；范围、非目标、验证结果和用户验收继续写回同一文件。

| 计划 | 主题 | 状态 |
| --- | --- | --- |
| [2026-08-09](./2026-08-09-reading-and-bulk-actions.md) | 阅读体验与批量操作修正 | 已验收 |
| [2026-08-09](./2026-08-09-tray-settings-and-auto-update.md) | 托盘、设置分组与自动更新 | 等待手动验收 |
