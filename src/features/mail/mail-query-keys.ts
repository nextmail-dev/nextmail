...
export const mailQueryKeys = {
  ...
  contactGroups: (accountId: string) => ["contacts", accountId, "groups"] as const,
  contactGroup: (accountId: string, groupId: string) => ["contacts", accountId, "group", groupId] as const,
