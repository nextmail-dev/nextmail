...
> [!IMPORTANT]
> NextMail 当前处于 `0.1.1` 预览阶段。Windows 10 22H2+ x64 是主要实机验收平台，macOS 12+ 是目标平台。项目会为 Linux 生成早期测试包，但尚未对 Linux 进行深度适配或实机验收。
...
NextMail 尚未提供 POP3、Google/Microsoft OAuth、统一收件箱、会话聚合、跨账户搜索、托盘、系统通知中心集成、自动更新或正式签名与公证。当前预览版和发布工作流均不暗示这些能力已经存在。
